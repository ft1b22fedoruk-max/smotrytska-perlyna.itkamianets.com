      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed text-accent italic">
            ...
            <a
              ...
              className="mt-8 inline-block border border-primary-foreground/40 px-8 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-primary-foreground transition-all hover:bg-primary-foreground hover:text-primary"
            >
